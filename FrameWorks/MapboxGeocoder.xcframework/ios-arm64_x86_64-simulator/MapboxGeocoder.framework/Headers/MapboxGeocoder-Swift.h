...
/// Normally you do not call this method to obtain a placemark. Instead, you call the <code>Geocoder.geocode(_:completionHandler:)</code> method, which asynchronously returns placemarks that match certain criteria.
/// \param identifier A string that uniquely identifies the feature.
///
/// \param name The common name of the placemark.
///
- (nonnull instancetype)initWithIdentifier:(NSString * _Nonnull)identifier name:(NSString * _Nonnull)name OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithIdentifier:(NSString * _Nonnull)identifier name:(NSString * _Nonnull)name SWIFT_UNAVAILABLE;
@end
