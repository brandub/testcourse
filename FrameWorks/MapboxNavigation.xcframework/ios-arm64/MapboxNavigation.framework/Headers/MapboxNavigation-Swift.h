...
#ifndef MAPBOXNAVIGATION_SWIFT_H
#define MAPBOXNAVIGATION_SWIFT_H
...
@interface MBCarPlayManager (SWIFT_EXTENSION(MapboxNavigation)) <MBNavigationCarPlayDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayManager (SWIFT_EXTENSION(MapboxNavigation)) <CPInterfaceControllerDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayManager (SWIFT_EXTENSION(MapboxNavigation)) <CPListTemplateDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayManager (SWIFT_EXTENSION(MapboxNavigation)) <CPApplicationDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayManager (SWIFT_EXTENSION(MapboxNavigation)) <CPMapTemplateDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayManager (SWIFT_EXTENSION(MapboxNavigation)) <CPSearchTemplateDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <MBRouteControllerDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <MBStyleManagerDelegate>
- (CLLocation * _Nullable)locationForStyleManager:(MBStyleManager * _Nonnull)styleManager SWIFT_WARN_UNUSED_RESULT;
- (void)styleManager:(MBStyleManager * _Nonnull)styleManager didApply:(MBStyle * _Nonnull)style;
- (void)styleManagerDidRefreshAppearance:(MBStyleManager * _Nonnull)styleManager;
@end
...
@interface MGLStyle (SWIFT_EXTENSION(MapboxNavigation))
...
@interface MBNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <MBTunnelIntersectionManagerDelegate>
...
SWIFT_PROTOCOL("_TtP16MapboxNavigation18StatusViewDelegate_")
@protocol StatusViewDelegate
@optional
...
SWIFT_PROTOCOL("_TtP16MapboxNavigation27StepsViewControllerDelegate_")
